...
const CandyMachine = ({ walletAddress }) => {
  ...
  const mintToken = async () => {
    try {
        ...
        async (notification, context) => {
          if (notification.type === 'status') {
            ...
            if (!result.err) {
              ...
              //set loading to false as NFT has been minted
              setIsMinting(false);
      ...
      //Set loading to false if we have an error
      setIsMinting(false);
  ...
  return (
    machineStats && (
      <div className="machine-container">
        ...
        <button className="cta-button mint-button" onClick={mintToken} disabled={isMinting} isMinting = {isMinting}>
          {isMinting ? `Minting...` : `Mint NFT`}
        </button>
        )}
      {/* If we have mints available in our array, let's render some items */}
      <p>{isLoadingMints && <LoadingIndicator />}</p>
